...
import hu.pagavcs.operation.CopyMoveRename.CopyMoveRenameStatus;
...
public class CopyMoveRenameGui implements Working, Cancelable {
	...
	public void display() throws SVNException {
		FormLayout layout = new FormLayout("right:p, 4dlu,p:g, p", "p,4dlu,p,4dlu,10dlu,p,4dlu,p,10dlu,p");
