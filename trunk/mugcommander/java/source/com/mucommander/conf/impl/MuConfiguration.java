...
public class MuConfiguration {
	...
	/**
	 * Whether or not to ask the user for confirmation before quitting
	 * muCommander.
	 */
	...
	/**
	 * System notifications are enabled by default on platforms where a notifier
	 * is available and works well enough. In particular, the system tray
	 * notifier is available under Linux+Java 1.6, but it doesn't work well so
	 * it is not enabled by default.
	 */
	public static final boolean DEFAULT_ENABLE_SYSTEM_NOTIFICATIONS = OsFamilies.MAC_OS_X
			.isCurrent();
	...
	public static final String LOG_BUFFER_SIZE = LOG_SECTION + '.'
			+ "buffer_size";
	/**
	 * Default log buffer size. Should be set to a low value to minimize memory
	 * usage, yet high enough to have most of the recent log messages.
	 */
	...
	/**
	 * Shell invocation command (in case muCommander is not using the default
	 * one).
	 */
	public static final String CUSTOM_SHELL = SHELL_SECTION + '.'
			+ "custom_command";
	/** Whether or not to use a custom shell invocation command. */
	public static final String USE_CUSTOM_SHELL = SHELL_SECTION + '.'
			+ "use_custom";
	...
	public static final String SHELL_HISTORY_SIZE = SHELL_SECTION + '.'
			+ "history_size";
	/** Encoding used to read the shell output. */
	public static final String SHELL_ENCODING = SHELL_SECTION + '.'
			+ "encoding";
	/** Whether or not shell encoding should be auto-detected. */
	public static final String AUTODETECT_SHELL_ENCODING = SHELL_SECTION + '.'
			+ "autodect_encoding";
	...
	public static final String MAIL_SENDER_NAME = MAIL_SECTION + '.'
			+ "sender_name";
	/** Address which mails sent by muCommander should be replied to. */
	public static final String MAIL_SENDER_ADDRESS = MAIL_SECTION + '.'
			+ "sender_address";
	...
	public static final String COMMAND_BAR_VISIBLE = COMMAND_BAR_SECTION + '.'
			+ "visible";
	...
	public static final String COMMAND_BAR_ICON_SCALE = COMMAND_BAR_SECTION
			+ '.' + "icon_scale";
	...
	public static final String STATUS_BAR_VISIBLE = STATUS_BAR_SECTION + '.'
			+ "visible";
	...
	public static final String TOOLBAR_VISIBLE = TOOLBAR_SECTION + '.'
			+ "visible";
	/** Default toolbar visibility. */
	public static final boolean DEFAULT_TOOLBAR_VISIBLE = true;
	/** Scale factor of toolbar icons. */
	public static final String TOOLBAR_ICON_SCALE = TOOLBAR_SECTION + '.'
			+ "icon_scale";
	...
	public static final String VOLUME_EXCLUDE_REGEXP = VOLUME_LIST_SECTION
			+ '.' + "exclude_regexp";
	...
	public static final String SHOW_HIDDEN_FILES = FILE_TABLE_SECTION + '.'
			+ "show_hidden_files";
	...
	public static final String SHOW_DS_STORE_FILES = FILE_TABLE_SECTION + '.'
			+ "show_ds_store_files";
	...
	public static final String SHOW_SYSTEM_FOLDERS = FILE_TABLE_SECTION + '.'
			+ "show_system_folders";
	...
	public static final String TABLE_ICON_SCALE = FILE_TABLE_SECTION + '.'
			+ "icon_scale";
	...
	public static final String AUTO_SIZE_COLUMNS = FILE_TABLE_SECTION + '.'
			+ "auto_size_columns";
	/** Default columns auto-resizing behavior. */
	public static final boolean DEFAULT_AUTO_SIZE_COLUMNS = true;
	/**
	 * Controls if and when system file icons should be used instead of custom
	 * file icons.
	 */
	public static final String USE_SYSTEM_FILE_ICONS = FILE_TABLE_SECTION + '.'
			+ "use_system_file_icons";
	...
	/**
	 * Controls whether folders are displayed first in the FileTable or mixed
	 * with regular files.
	 */
	public static final String SHOW_FOLDERS_FIRST = FILE_TABLE_SECTION + '.'
			+ "show_folders_first";
	...
	public static final String CD_FOLLOWS_SYMLINKS = FILE_TABLE_SECTION + '.'
			+ "cd_follows_symlinks";
	...
	public static final String LEFT_FILE_TABLE_SECTION = FILE_TABLE_SECTION
			+ '.' + LEFT;
	/** Section describing the right table's configuration. */
	public static final String RIGHT_FILE_TABLE_SECTION = FILE_TABLE_SECTION
			+ '.' + RIGHT;
	...
	public static final String RIGHT_FILE_TABLE_SORT_SECTION = LEFT_FILE_TABLE_SECTION
			+ '.' + SORT;
	/** Section described the sort order of the left file table. */
	public static final String LEFT_FILE_TABLE_SORT_SECTION = RIGHT_FILE_TABLE_SECTION
			+ '.' + SORT;
	/** Controls the column on which the left file table should be sorted. */
	public static final String LEFT_SORT_BY = LEFT_FILE_TABLE_SORT_SECTION
			+ '.' + SORT_BY;
	/** Controls the column on which the right file table should be sorted. */
	public static final String RIGHT_SORT_BY = RIGHT_FILE_TABLE_SORT_SECTION
			+ '.' + SORT_BY;
	/** Controls the column on which the left file table should be sorted. */
	public static final String LEFT_SORT_ORDER = LEFT_FILE_TABLE_SORT_SECTION
			+ '.' + SORT_ORDER;
	/** Controls the column on which the right file table should be sorted. */
	public static final String RIGHT_SORT_ORDER = RIGHT_FILE_TABLE_SORT_SECTION
			+ '.' + SORT_ORDER;
	...
	/**
	 * Name of the root element's attribute that contains the version of
	 * muCommander used to write the configuration file.
	 */
	static final String VERSION_ATTRIBUTE = "version";

	/**
	 * Returns the configuration section corresponding to the specified
	 * {@link com.mucommander.ui.main.table.FileTable}, left or right one.
	 * 
	 * @param left
	 *            true for the left FileTable, false for the right one
	 * @return the configuration section corresponding to the specified
	 *         FileTable
	 */
	...
	/**
	 * Returns the configuration section corresponding to the specified column
	 * in the left or right {@link com.mucommander.ui.main.table.FileTable}.
	 * 
	 * @param column
	 *            column, see {@link com.mucommander.ui.main.table.Column} for
	 *            possible values
	 * @param left
	 *            true for the left FileTable, false for the right one
	 * @return the configuration section corresponding to the specified
	...
	private static String getColumnSection(Column column, boolean left) {
		return getFileTableSection(left) + "."
				+ column.toString().toLowerCase();
	}

	/**
	 * Returns the variable that controls the visibility of the specified
	 * column, in the left or right
	...
	/**
	 * Returns the variable that holds the width of the specified column, in the
	 * left or right {@link com.mucommander.ui.main.table.FileTable}.
	 * 
	 * @param column
	 *            column, see {@link com.mucommander.ui.main.table.Column} for
	 *            possible values
	...
	/**
	 * Returns the variable that holds the position of the specified column, in
	 * the left or right {@link com.mucommander.ui.main.table.FileTable}.
	 * 
	 * @param column
	 *            column, see {@link com.mucommander.ui.main.table.Column} for
	 *            possible values
	...
	public static final String USE_BRUSHED_METAL = MAC_OSX_SECTION + '.'
			+ "brushed_metal_look";
	/** Default brushed metal look behavior. */
	// At the time of writing, the 'brushed metal' look causes the JVM to crash
	// randomly under Leopard (10.5)
	// so we disable brushed metal on that OS version but leave it for earlier
	// versions where it works fine.
	// See http://www.mucommander.com/forums/viewtopic.php?f=4&t=746 for more
	...
	public static final String USE_SCREEN_MENU_BAR = MAC_OSX_SECTION + '.'
			+ "screen_menu_bar";
	...
	public static final String RIGHT_STARTUP_FOLDER_SECTION = STARTUP_FOLDER_SECTION
			+ '.' + RIGHT;
	/** Section describing the left panel's startup folder. */
	public static final String LEFT_STARTUP_FOLDER_SECTION = STARTUP_FOLDER_SECTION
			+ '.' + LEFT;
	...
	public static final String LAST_LEFT_FOLDER = LEFT_STARTUP_FOLDER_SECTION
			+ '.' + LAST_FOLDER;
	/** Last visited folder in the right panel. */
	public static final String LAST_RIGHT_FOLDER = RIGHT_STARTUP_FOLDER_SECTION
			+ '.' + LAST_FOLDER;
	...
	public static final String LEFT_CUSTOM_FOLDER = LEFT_STARTUP_FOLDER_SECTION
			+ '.' + CUSTOM_FOLDER;
	/** Path to the right panel custom startup folder. */
	public static final String RIGHT_CUSTOM_FOLDER = RIGHT_STARTUP_FOLDER_SECTION
			+ '.' + CUSTOM_FOLDER;
	/** Startup folder type. */
	...
	public static final String LEFT_STARTUP_FOLDER = LEFT_STARTUP_FOLDER_SECTION
			+ '.' + STARTUP_FOLDER;
	/** Type of startup folder that should be used in the right panel. */
	public static final String RIGHT_STARTUP_FOLDER = RIGHT_STARTUP_FOLDER_SECTION
			+ '.' + STARTUP_FOLDER;
	...
	public static final String LAST_HEIGHT = LAST_WINDOW_SECTION + '.'
			+ "height";
	/** Last known screen width. */
	public static final String SCREEN_WIDTH = LAST_WINDOW_SECTION + '.'
			+ "screen_width";
	/** Last known screen height. */
	public static final String SCREEN_HEIGHT = LAST_WINDOW_SECTION + '.'
			+ "screen_height";
	/** Last orientation used to split folder panels. */
	public static final String SPLIT_ORIENTATION = LAST_WINDOW_SECTION + '.'
			+ "split_orientation";
	...
	/**
	 * Frequency at which the current folder is checked for updates, -1 to
	 * disable auto refresh.
	 */
	public static final String REFRESH_CHECK_PERIOD = REFRESH_SECTION + '.'
			+ "check_period";
	/** Default folder refresh frequency. */
	public static final long DEFAULT_REFRESH_CHECK_PERIOD = 3000;
	/**
	 * Minimum amount of time a folder should be checked for updates after it's
	 * been refreshed.
	 */
	public static final String WAIT_AFTER_REFRESH = REFRESH_SECTION + '.'
			+ "wait_after_refresh";
	...
	public static final String PROGRESS_DIALOG_EXPANDED = PROGRESS_DIALOG_SECTION
			+ '.' + "expanded";
	/** Default progress dialog expanded state. */
	public static final boolean DEFAULT_PROGRESS_DIALOG_EXPANDED = true;
	/**
	 * Controls whether or not the progress dialog should be closed when the job
	 * is finished.
	 */
	public static final String PROGRESS_DIALOG_CLOSE_WHEN_FINISHED = PROGRESS_DIALOG_SECTION
			+ '.' + "close_when_finished";
	...
	/**
	 * Used do determine whether discovery of Bonjour services should be
	 * activated or not.
	 */
	public static final String ENABLE_BONJOUR_DISCOVERY = BONJOUR_SECTION + '.'
			+ "discovery_enabled";
	...
	/**
	 * Controls whether hidden files should be listed by the client (LIST -al
	 * instead of LIST -l).
	 */
	public static final String LIST_HIDDEN_FILES = FTP_SECTION + '.'
			+ "list_hidden_files";
	...
	/**
	 * Controls the authentication protocol to use when connecting to SMB
	 * servers.
	 */
	public static final String SMB_LM_COMPATIBILITY = SMB_SECTION + '.'
			+ "lm_compatibility";
	 ...
	 * servers.
	 */
	public static final String SMB_USE_EXTENDED_SECURITY = SMB_SECTION + '.'
			+ "use_extended_security";
	...
	public static final String LEFT_TREE_VISIBLE = TREE_SECTION + "." + LEFT
			+ "." + "visible";
	public static final String RIGHT_TREE_VISIBLE = TREE_SECTION + "." + RIGHT
			+ "." + "visible";
	public static final String LEFT_TREE_WIDTH = TREE_SECTION + "." + LEFT
			+ "." + "width";
	public static final String RIGHT_TREE_WIDTH = TREE_SECTION + "." + RIGHT
			+ "." + "width";
	...
	public static final String EDITOR_FRAME_EXTENDED_STATE = EDITOR_FRAME_SECTION
			+ '.' + "extended_state";
	/** Last Editor Frame known x position. */
	public static final String EDITOR_FRAME_X = EDITOR_FRAME_SECTION + '.'
			+ "x";
	/** Last Editor Frame known y position. */
	public static final String EDITOR_FRAME_Y = EDITOR_FRAME_SECTION + '.'
			+ "y";
	/** Last Editor Frame known width. */
	public static final String EDITOR_FRAME_WIDTH = EDITOR_FRAME_SECTION + '.'
			+ "width";
	/** Last Editor Frame known height. */
	public static final String EDITOR_FRAME_HEIGHT = EDITOR_FRAME_SECTION + '.'
			+ "height";

	// - Instance fields -----------------------------------------------------
	// -----------------------------------------------------------------------
	private static final Configuration configuration = new Configuration(
			new MuConfigurationSource());
	 ...
	 *             if a configuration related error occurs.
	 */
	public static void read() throws IOException, ConfigurationException {
		...
		try {
			...
			if (configurationVersion == null
					|| !configurationVersion.equals(RuntimeConstants.VERSION)) {
	...
	public static void write() throws IOException, ConfigurationException {
		configuration.write(new VersionedXmlConfigurationWriter());
	}
	 ...
	 * <p>
	 * At the end of this call, <code>fromVar</code> will have been deleted.
	 * Note that if <code>fromVar</code> doesn't exist, but <code>toVar</code>
	 * does, <code>toVar</code> will be deleted.
	 * </p>
	 * <p>
	 * This method might trigger as many as two
	 * {@link com.mucommander.conf.ConfigurationEvent events}:
	 * <ul>
	 ...
	 * 
	 * @param fromVar
	 *            fully qualified name of the variable to rename.
	 * @param toVar
	 *            fully qualified name of the variable that will receive
	 *            <code>fromVar</code>'s value.
	 */
	 ...
	 * <p>
	 * This method will return <code>false</code> if it didn't modify
	 * <code>name</code>'s value. Note that this doesn't mean the call failed,
	 * but that <code>name</code>'s value was already equal to
	 * <code>value</code>.
	 * </p>
	 * <p>
	 * If the value of the specified variable is actually modified, an
	 * {@link com.mucommander.conf.ConfigurationEvent event} will be passed to
	 * all listeners.
	 * </p>
	 * 
	 * @param name
	 *            fully qualified name of the variable to set.
	 * @param value
	 *            new value for the variable.
	 * @return <code>true</code> if this call resulted in a modification of the
	 *         variable's value, <code>false</code> otherwise.
	 * @see #getVariable(String)
	 * @see #getVariable(String,String)
	 */
	public static boolean setVariable(String name, String value) {
		return configuration.setVariable(name, value);
	}
	 ...
	 * <p>
	 * This method will return <code>false</code> if it didn't modify
	 * <code>name</code>'s value. This, however, is not a way of indicating that
	 * the call failed: <code>false</code> is only ever returned if the previous
	 ...
	 */
	public static boolean setVariable(String name, long value) {
		return configuration.setVariable(name, value);
	}
	 ...
	 *            new value for the variable.
	 * @param separator
	 *            string used to separate each element of the list.
	 * @return <code>true</code> if this call resulted in a modification of the
	 *         variable's value, <code>false</code> otherwise.
	 * @see #getListVariable(String,String)
	 * @see #getVariable(String,List,String)
	 */
	public static boolean setVariable(String name, List<String> value,
			String separator) {
		return configuration.setVariable(name, value, separator);
	}
	 ...
	 * 
	 * @param name
	 *            fully qualified name of the variable whose value should be
	 *            retrieved.
	 ...
	 *             if the variable's value cannot be cast to an integer.
	 * @see #setVariable(String,int)
	 * @see #getVariable(String,int)
	 */
	public static int getIntegerVariable(String name) {
		return configuration.getIntegerVariable(name);
	}
	 ...
	 * @return the variable's value if set, <code>0</code> otherwise.
	 * @throws NumberFormatException
	 *             if the variable's value cannot be cast to a long.
	 * @see #setVariable(String,long)
	 * @see #getVariable(String,long)
	 */
	public static long getLongVariable(String name) {
		return configuration.getLongVariable(name);
	}
	 ...
	 * @return the variable's value if set, <code>0</code> otherwise.
	 * @throws NumberFormatException
	 *             if the variable's value cannot be cast to a float.
	 * @see #setVariable(String,float)
	 * @see #getVariable(String,float)
	 */
	public static float getFloatVariable(String name) {
		return configuration.getFloatVariable(name);
	}
	 ...
	 * @return the variable's value if set, <code>0</code> otherwise.
	 * @throws NumberFormatException
	 *             if the variable's value cannot be cast to a double.
	 * @see #setVariable(String,double)
	 * @see #getVariable(String,double)
	 */
	public static double getDoubleVariable(String name) {
		return configuration.getDoubleVariable(name);
	}
	 ...
	 * @see #getVariable(String,boolean)
	 */
	public static boolean getBooleanVariable(String name) {
	 ...
	 *            retrieved.
	 * @param separator
	 *            character used to split the variable's value into a list.
	 * @return the variable's value if set, <code>null</code> otherwise.
	 * @see #setVariable(String,List,String)
	 * @see #getVariable(String,List,String)
	 */
	public static ValueList getListVariable(String name, String separator) {
		return configuration.getListVariable(name, separator);
	}
	 ...
	 * 
	 * @param name
	 *            fully qualified name of the variable to check for.
	 * @return <code>true</code> if the variable is set, <code>false</code>
	 *         otherwise.
	 */
	public static boolean isVariableSet(String name) {
		return configuration.isVariableSet(name);
	}
	 ...
	 * <p>
	 * If the variable was set, a configuration
	 * {@link com.mucommander.conf.ConfigurationEvent event} will be passed to
	 ...
	 */
	public static int removeIntegerVariable(String name) {
		return configuration.removeIntegerVariable(name);
	}
	 ...
	 * @return the variable's old value, or <code>0</code> if it wasn't set.
	 */
	public static long removeLongVariable(String name) {
		return configuration.removeLongVariable(name);
	}
	 ...
	 * @return the variable's old value, or <code>0</code> if it wasn't set.
	 */
	public static float removeFloatVariable(String name) {
		return configuration.removeFloatVariable(name);
	}
	 ...
	 * @return the variable's old value, or <code>0</code> if it wasn't set.
	 */
	public static double removeDoubleVariable(String name) {
		return configuration.removeDoubleVariable(name);
	}
	 ...
	 */
	public static boolean removeBooleanVariable(String name) {
		return configuration.removeBooleanVariable(name);
	}
	 ...
	 * @return the variable's old value, or <code>null</code> if it wasn't set.
	 */
	public static ValueList removeListVariable(String name, String separator) {
		return configuration.removeListVariable(name, separator);
	}
	 ...
	 * <code>defaultValue</code> before returning it. If this happens, a
	 * configuration {@link com.mucommander.conf.ConfigurationEvent event} will
	 ...
	 *            name of the variable to retrieve.
	 * @param defaultValue
	 *            value to use if variable <code>name</code> is not set.
	 * @param separator
	 *            separator to use for <code>defaultValue</code> if variable
	 *            <code>name</code> is not set.
	 * @return the specified variable's value.
	 * @see #setVariable(String,List,String)
	 * @see #getListVariable(String,String)
	 */
	public static ValueList getVariable(String name, List<String> defaultValue,
			String separator) {
		return configuration.getVariable(name, defaultValue, separator);
	}
	 ...
	 * 
	 * @param listener
	 *            object to register as a configuration listener.
	...
	/**
	 * Removes the specified object from the list of registered configuration
	 * listeners.
	 * 
	 * @param listener
	 *            object to remove from the list of registered configuration
	 *            listeners.
	 ...
	 * 
	 * @param file
	 *            path to the file that should be used for configuration
	 *            storage.
	 * @throws FileNotFoundException
	 *             if the specified file is not a valid file.
	 ...
	 */
	public static AbstractFile getConfigurationFile() throws IOException {
		return MuConfigurationSource.getConfigurationFile();
	}
}
