...
public class PagaVcsIntegration {
	...
	public synchronized static ImageIcon getIcon(String name) throws UnknownHostException, IOException, ClassNotFoundException {
		initPagaVcsIcon();
	...
	private static void initPagaVcsIcon() throws UnknownHostException, IOException, ClassNotFoundException {
		if (mapPagaVcsIcon == null) {
			...
			int actionWidth = 16;
			int actionHeight = 16;
			initOnePagaVcsIcon("actions/pagavcs-about", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-add", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-annotate", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-applypatch", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-asynchronous", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-branch", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-bug", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-checkout", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-cleanup", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-clear", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-commit", actionWidth, actionHeight);
			...
			initOnePagaVcsIcon("actions/pagavcs-help", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-ignore", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-import", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-lock", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-logo", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-log", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-merge", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-other", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-properties", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-refresh", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-relocate", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-rename", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-resolve", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-revert", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-run", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-settings", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-show_log", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-stop", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-switch", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-unignore", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-unlock", actionWidth, actionHeight);
			initOnePagaVcsIcon("actions/pagavcs-update", actionWidth, actionHeight);
		}
	}
}
