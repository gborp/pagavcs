...
public class Table<L extends ListItem> extends JTable {
	...
	private String messageBorderLayoutLocation;
	...
	public Table(TableModel<L> tableModel) {
		...
		messageBorderLayoutLocation = BorderLayout.CENTER;
	}
	...
	public void showMessage(String message, Icon icon) {
		...
		add(lblMessage, messageBorderLayoutLocation);
		revalidate();
		repaint();
	}
	...
	public void setMssageBorderLayoutLocation(String messageBorderLayoutLocation) {
		this.messageBorderLayoutLocation = messageBorderLayoutLocation;
	}
