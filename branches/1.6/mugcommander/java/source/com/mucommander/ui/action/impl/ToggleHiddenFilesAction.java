...
public class ToggleHiddenFilesAction extends MuAction {
	...
	// -----------------------------------------------------------------------------------
	/**
	 * Toggles hidden files display on and off and requests for all file tables
	 * to be repainted.
	 */
	@Override
	public void performAction() {
		MuConfiguration.setVariable(MuConfiguration.SHOW_HIDDEN_FILES, !MuConfiguration.getVariable(MuConfiguration.SHOW_HIDDEN_FILES,
		        MuConfiguration.DEFAULT_SHOW_HIDDEN_FILES));
	...
	public static class Descriptor extends AbstractActionDescriptor {
		...
		public KeyStroke getDefaultKeyStroke() {
			return KeyStroke.getKeyStroke(KeyEvent.VK_H, KeyEvent.CTRL_DOWN_MASK);
		}
	}
}
