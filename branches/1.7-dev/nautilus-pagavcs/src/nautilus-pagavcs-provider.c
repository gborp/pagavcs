...
GList* nautilus_pagavcs_get_background_items(
		NautilusMenuProvider* provider, GtkWidget* window,
...
GList* nautilus_pagavcs_get_background_items(
	...
	root_item = nautilus_menu_item_new("NautilusPagaVCS::root_item", "PagaVCS",
			"PagaVCS", GTK_STOCK_FLOPPY);
	...
	item = nautilus_menu_item_new("NautilusPagaVCS::update", "Update", "Update",
			NULL );
