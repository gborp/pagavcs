...
/**
 * This class is responsible to handle the attributes of CommandBars - their
 * actions, alternate actions and modifier. Every CommandBar should get its
 * attributes from this class, and register in it for receiving attributes
 * modifications.
 * 
 * @author Arik Hadas
 */
public class CommandBarAttributes {
	...
	private static final String                                 DEFAULT_ACTION_IDS[]           = {
	        com.mucommander.ui.action.impl.ViewAction.Descriptor.ACTION_ID, com.mucommander.ui.action.impl.EditAction.Descriptor.ACTION_ID,
	        com.mucommander.ui.action.impl.CopyAction.Descriptor.ACTION_ID, com.mucommander.ui.action.impl.MoveAction.Descriptor.ACTION_ID,
	        com.mucommander.ui.action.impl.MkdirAction.Descriptor.ACTION_ID, com.mucommander.ui.action.impl.DeleteAction.Descriptor.ACTION_ID,
	        com.mucommander.ui.action.impl.RefreshAction.Descriptor.ACTION_ID, com.mucommander.ui.action.impl.CloseWindowAction.Descriptor.ACTION_ID };
	/** Command bar default alternate actions */
	private static final String                                 DEFAULT_ALTERNATE_ACTION_IDS[] = { null,
	        com.mucommander.ui.action.impl.EditNativelyAction.Descriptor.ACTION_ID, com.mucommander.ui.action.impl.LocalCopyAction.Descriptor.ACTION_ID,
	        com.mucommander.ui.action.impl.RenameAction.Descriptor.ACTION_ID, com.mucommander.ui.action.impl.MkfileAction.Descriptor.ACTION_ID,
	        com.mucommander.ui.action.impl.PermanentDeleteAction.Descriptor.ACTION_ID, null, null };
	/**
	 * Default modifier key that triggers the display of alternate actions when
	 * pressed
	 */
	private static KeyStroke                                    DEFAULT_MODIFIER               = KeyStroke.getKeyStroke(KeyEvent.VK_SHIFT, 0);

	/**
	 * Contains all registered command-bar attributes listeners, stored as weak
	 * references
	 */
	private static WeakHashMap<CommandBarAttributesListener, ?> listeners                      = new WeakHashMap<CommandBarAttributesListener, Object>();

	/**
	 * This method restore the default command-bar attributes. The attributes
	 * are updated only if they are not already equal to the default attributes.
	 */
	 ...
	 * 
	 * @param actionIds
	 *            standard command-bar actions.
	 * @param alternateActionIds
	 *            alternate command-bar actions.
	 * @param modifier
