 ...
 * the {@link IconManager#FILE_ICON_SET IconManager's custom file icon set},
 * based on files' extension and type. No caching is performed by this class as
 * {@link IconManager} already takes care of this.
 * 
...
public class CustomFileIconProvider implements FileIconProvider {
	...
	/**
	 * File icon <-> extensions association map. For information about specific
	 * file extensions, refer to:
	 * <ul>
	 * <li><a
	 * href="http://en.wikipedia.org/wiki/File_format">http://en.wikipedia
	 * .org/wiki/File_format</a></li>
	 * <li><a href="http://filext.com/">http://filext.com/</a></li>
	 * <li><a href="http://whatis.techtarget.com/fileFormatP/">http://whatis.
	 * techtarget.com/fileFormatP/</a></li>
	 * <li><a href="http://www.fileinfo.net">http://www.fileinfo.net</a></li>
	 * </ul>
	 */
	final static String                      ICON_EXTENSIONS[][]     = {
	        { "archive_unsupported.png", "7z", "ace", "arj", "bin", "bz", "cab", "dmg", "hqx", "ipk", "lha", "lzh", "lzx", "msi", "mpkg", "pak", "pkg", "pq6",
	        "rar", "rk", "rz", "sea", "sit", "sitx", "sqx", "z", "zoo" }, // Unsupported
	        // archive
	        // formats
	        // (no
	        // native
	        ...
	        { "audio.png", "aac", "aif", "aiff", "aifc", "amr", "ape", "au", "cda", "mp3", "mpa", "mp2", "mpc", "m3u", "m4a", "m4b", "m4p", "nap", "ogg",
	        "pls", "ra", "ram", "wav", "wave", "flac", "wma", "mid", "midi", "smf", "mod", "mtm", "xm", "s3m", "mka" }, // Audio
	        // formats,
	        // see
	        // http://en.wikipedia.org/wiki/Audio_file_format
	        { "cd_image.png", "iso", "nrg" }, // CD/DVD image
	        { "certificate.png", "cer", "crt", "key" }, // Certificate file
	        { "configuration.png", "cnf", "conf", "config", "inf", "ini", "pif", "prefs", "prf" }, // Configuration
	        // file
	        { "database.png", "myi", "myd", "frm", "sql", "sqc", "sqr", "mdb", "mde", "mdn", "mdt", "accdb", "accde", "accdr", "accdt" }, // Database
	        // file
	        { "executable_windows.png", "bat", "com", "exe" }, // Windows
	        // executables
	        { "feed.png", "rdf", "rss" }, // RSS/RDF feed
	        { "font.png", "fnt", "fon", "otf" }, // Non-TrueType font
	        { "font_truetype.png", "ttc", "ttf" }, // TrueType font
	        { "image_bitmap.png", "exif", "ico", "gif", "j2k", "jpg", "jpeg", "jpg2", "jp2", "bmp", "ico", "iff", "mng", "pcd", "pic", "pict", "png", "psd",
	        "psp", "pbm", "pgm", "ppm", "raw", "tga", "tiff", "tif", "wbmp", "xbm", "xcf", "xpm" }, // Bitmap
	        // image
	        // formats,
	        // see
	        ...
	        { "image_vector.png", "ai", "cgm", "dpx", "dxf", "eps", "emf", "ps", "svg", "svgz", "wmf", "xar" }, // Vector
	        // image
	        // formats,
	        // http://en.wikipedia.org/wiki/Graphics_file_format
	        ...
	        { "macromedia_flash.png", "swf", "swd", "swa", "swc", "fla", "flv", "flp", "jsfl" }, // Macromedia
	        // Flash
	        { "macromedia_freehand.png", "fh", "fhd" }, // Macromedia Freehand
	        { "ms_excel.png", "xls", "xla", "xlb", "xlc", "xld", "xlk", "xll", "xlm", "xlr", "xlt", "xlv", "xlw", "xlshtml", "xlsmhtml", "xlthtml", "xlsx",
	        "xltx", "xlsm", "xltm", "xlam", "xlsb" }, // Microsoft Excel
	        { "ms_word.png", "doc", "wbk", "wiz", "wpg", "wpk", "wpm", "wpt", "wrs", "wwl", "docx", "dotx", "docm", "dotm" }, // Microsoft
	        // Word
	        { "ms_powerpoint.png", "pcb", "pot", "ppa", "ppi", "pps", "ppt", "pwz", "pptx", "potx", "ppsx", "pptm", "potm", "ppsm" }, // Microsoft
	        // Office
	        // (Powerpoint)
	        { "ms_visualstudio.png", "atp", "dbp", "hxc", "ncb", "pch", "pdb", "sln", "suo", "srf", "vaf", "vam", "vbg", "vbp", "vbproj", "vcproj", "vdp",
	        "vdproj", "vip", "vmx", "vsdir", "vsmacros", "vsmproj", "vup" }, // Microsoft
	        // Visual
	        // Studio
	        { "ms_windows_shortcut.png", "lnk" }, // MS Windows .lnk shortcut
	        // files
	        { "pdf.png", "pdf" }, // Adobe Acrobat / PDF
	        { "source.png", "asm", "asp", "bas", "bcp", "cbl", "cob", "f", "fpp", "inc", "js", "lsp", "m4", "pas", "pl", "py", "src", "vb", "vbe", "vbs", "x" }, // Languages
	        // for
	        // which
	        // there
	        // is
	        ...
	        // source
	        // icon)
	        { "source.png", "awk", "csh", "esh", "sh", "ksh", "ws", "wsf" }, // Shell
	        // scripts
	        ...
	        { "source_php.png", "php", "php3", "php4", "php5", "phtm", "phtml" }, // PHP
	        // source
	        { "source_ruby.png", "rb", "rbx", "rhtml" }, // Ruby source
	        { "source_web.png", "html", "htm", "xhtml", "wml", "wmlc", "wmls", "wmlsc", "hdml", "xhdml", "chtml", "vrml", "torrent", "url", "css" }, // Web
	        // formats
	        { "source_xml.png", "xml", "dtd", "xfd", "xfdl", "xmap", "xmi", "xsc", "xsd", "xsl", "xslt", "xtd", "xul", "rss", "jnlp", "plist" }, // XML-based
	        // formats
	        { "text.png", "1st", "ans", "asc", "ascii", "diz", "err", "faq", "latex", "log", "man", "msg", "nfo", "readme", "rtf", "sig", "tex", "text", "txt" }, // Text
	        // formats
	        { "vcard.png", "vcf" }, // vCard
	        { "video.png", "3g2", "3gp", "3gp2", "3gpp", "asf", "asx", "avi", "dir", "dv", "dxr", "m1v", "m4e", "m4u", "moov", "mov", "movie", "mp4", "mpe",
	        "mpeg", "mpg", "mpv2", "qt", "rm", "rmvb", "rts", "vob", "wmv", "divx", "mkv" } // Video
	                                                                 // formats
	                                                                 };
	...
	public Icon getFileIcon(AbstractFile file, Dimension preferredResolution) {
		return getSvnDecoratedFileIcon(getFileIcon2(file, preferredResolution), new File(file.getAbsolutePath()));
	}
	...
	public Icon getFileIcon2(AbstractFile file, Dimension preferredResolution) {
		...
		// If file is a symlink, get the linked file's icon and paint a
		// semi-transparent symbolic icon on top of it
		...
		if (!FileProtocols.FILE.equals(file.getURL().getScheme()) && file.isRoot()) {
			...
			// Mac OS X application are directories with the .app extension and
		...
		// If the file is browsable (supported archive or other), use an icon
		// symbolizing an archive
		...
		// Regular file icon
			...
			if (fileExtension == null)
				...
				if (iconName == null) // No icon associated to extension, use
					// default file icon
					icon = IconManager.getIcon(IconManager.FILE_ICON_SET, FILE_ICON_NAME);
				else {
					// Retrieves the cached (or freshly loaded if not in cache
					// already) ImageIcon instance corresponding to the icon's
					// name
					icon = IconManager.getIcon(IconManager.FILE_ICON_SET, iconName);
					// Returned IconImage should never be null, but if it is
					// (icon file missing), return default file icon
					if (icon == null)
		...
		// If file is a symlink, paint a semi-transparent symbolic icon over the
		// linked file's icon
		if (isSymlink)
